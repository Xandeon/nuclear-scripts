...
fn print_constants(){
    println!("a_v: {:.2} MeV", A_V);
    println!("a_s: {:.2} MeV", A_S);
    println!("a_c: {:.2} MeV", A_C);
    println!("a_A: {:.2} MeV", A_A);
    println!("a_p: {:.2} MeV", A_P);
}
...
impl Isotope{
    fn create_isotope(element: String, A: i32, Z: i32, N: i32) -> Self{
        Self{
            element, A, Z, N,
        }
    }
    ...
    fn binding_energy_per_nucleon(&self) -> f64{
